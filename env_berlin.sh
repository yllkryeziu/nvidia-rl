#!/bin/bash
# env_berlin.sh - source this before running distillation on the Berlin cluster
# Usage: source env_berlin.sh

# Base project data directory
export YLLI_DATA_DIR="/fast/project/HFMI_SynergyUnit/ylli"
